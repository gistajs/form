...
# Optional: provision a hosted Turso database and save DB_URL/DB_AUTH_TOKEN
pnpm db:provision
...
- `pnpm db:provision` can create a Turso database later and save `DB_URL` plus `DB_AUTH_TOKEN` to `.env`.
