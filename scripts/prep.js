...
console.log(
  'Setup complete. Database created, seeded Alice/Bob, and auth links will be emailed when SMTP is configured or logged to the console otherwise.',
)
...
if (!dbUrl) {
  console.log(
    'Optional: run `pnpm provision` later to provision Turso and Vercel for production.',
  )
}
