  ...
  return (
    ...
    >
      ...
      <div className={isCard ? 'p-6 pt-5' : ''}>
        ...
        {/* Fields */}
        <fieldset disabled={readOnly} className="mt-5 min-w-0 border-0 p-0">
...
type FormPreviewProps = {
  ...
  card?: boolean
  /** Omit title/description/badge when the scaffold toolbar already shows them (new-form builder). */
  hideFormMeta?: boolean
}
