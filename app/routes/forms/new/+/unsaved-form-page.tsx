  ...
  return (
    <>
      ...
      <Form
        ...
        onSubmit={(event) => {
          ...
          if (
            ...
            let fd = new FormData()
            fd.set('scaffold', JSON.stringify(serializeScaffold(nextScaffold)))
      ...
      >
        ...
        <div className="mt-6 grid items-start gap-8 lg:grid-cols-[minmax(0,1.32fr)_minmax(0,1fr)]">
          <div
            className={cn(
          ...
          >
            <FormPreview
              ...
              readOnly
              title="Live Preview"
              hideFormMeta={isAvailabilityPoll}
            />
          </div>
        </div>
      </Form>
