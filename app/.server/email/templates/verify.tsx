...
export default function Verify({ user, url }: Props) {
  return (
    <Layout
      badge="Verify email"
      title="Welcome in"
      subtitle="Confirm your email address to unlock your account and finish setting up your access."
    >
      <P>Hello {user.name || user.email},</P>
      <P>
        One quick click confirms this email address and turns on the rest of
        your auth flow.
      </P>
